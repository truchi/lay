...
impl Styler for Foreground {
    ...
    /// Returns a [`Style`](crate::Style) with `foreground`.
    ...
    /// Returns a [`Style`](crate::Style) with `foreground` (self) and
    /// `background`.
    ...
    /// Returns a [`Style`](crate::Style) with `foreground` (self) and `weight`.
    ...
    /// Returns a [`Style`](crate::Style) with `foreground` (self) and `slant`.
    ...
    /// Returns a [`Style`](crate::Style) with `foreground` (self) and `strike`.
    ...
    /// Returns a [`Style`](crate::Style) with `foreground` (self) and `invert`.
    ...
    /// Returns a [`Style`](crate::Style) with `foreground` (self) and `blink`.
    ...
    /// Returns a [`Style`](crate::Style) with `foreground` (self) and `border`.
